<!---
    This file is automatically generated using the gen_simpleblocks_docs.py script, 
    and information and docstrings from simpleblocks and the SimpleBuild framework.
...
### Extra simpleconfig parameters specific to ``BinariesTarball`` simpleblock

simpleconfig parameter|description                                                                                                                                                  |default value
--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------
...
### Customised steps in ``BinariesTarball`` simpleblock
...
### Customised steps in ``Binary`` simpleblock
...
### Example simpleconfig for ``Binary`` simpleblock
...
### Extra simpleconfig parameters specific to ``BuildEnv`` simpleblock
...
``components``                 |List of components to install: tuples w/ name, version and simpleblock to use|``()``
``default_component_specs``    |Default specs to use for every component                                   |``{}``
``default_simpleblock``          |Default simpleblock to use for components                                    |``None``
...
### Extra simpleconfig parameters specific to ``Bundle`` simpleblock
...
### Customised steps in ``Bundle`` simpleblock
...
### Example simpleconfig for ``Bundle`` simpleblock
...
### Extra simpleconfig parameters specific to ``CMakeMake`` simpleblock
...
``host_type``                   |Value to provide to --host option of configure script, e.g., x86_64-pc-linux-gnu (determined by config.guess shipped with SimpleBuild if None, False implies to leave it up to the configure script)|``None``
...
### Customised steps in ``CMakeMake`` simpleblock
...
### Example simpleconfig for ``CMakeMake`` simpleblock
...
### Extra simpleconfig parameters specific to ``CMakeMakeCp`` simpleblock
...
### Customised steps in ``CMakeMakeCp`` simpleblock
...
### Extra simpleconfig parameters specific to ``CMakeNinja`` simpleblock
...
### Customised steps in ``CMakeNinja`` simpleblock
...
### Extra simpleconfig parameters specific to ``CMakePythonPackage`` simpleblock
...
### Customised steps in ``CMakePythonPackage`` simpleblock
...
(derives from ``ExtensionSimpleBlock``)

Support for installing Cargo packages (Rust)

### Extra simpleconfig parameters specific to ``Cargo`` simpleblock
...
### Customised steps in ``Cargo`` simpleblock
...
### Extra simpleconfig parameters specific to ``CargoPythonPackage`` simpleblock
...
### Extra simpleconfig parameters specific to ``CmdCp`` simpleblock

simpleconfig parameter            |description                                                                                                                                                                                        |default value
--------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------
``build_cmd``                   |Build command to use                                                                                                                                                                               |``"make"``
``build_cmd_targets``           |Target name (string) or list of target names to build                                                                                                                                              |``""``
``build_type``                  |Value to provide to --build option of configure script, e.g., x86_64-pc-linux-gnu (determined by config.guess shipped with SimpleBuild if None, False implies to leave it up to the configure script)|``None``
...
### Customised steps in ``CmdCp`` simpleblock
...
### Extra simpleconfig parameters specific to ``Conda`` simpleblock
...
### Customised steps in ``Conda`` simpleblock
...
### Extra simpleconfig parameters specific to ``ConfigureMake`` simpleblock
...
### Commonly used simpleconfig parameters with ``ConfigureMake`` simpleblock

simpleconfig parameter|description
--------------------|----------------------------------------------------------------
configopts          |Extra options passed to configure (default already has --prefix)
buildopts           |Extra options passed to make step (default already has -j X)
installopts         |Extra options for installation

### Customised steps in ``ConfigureMake`` simpleblock
...
### Example simpleconfig for ``ConfigureMake`` simpleblock
...
### Extra simpleconfig parameters specific to ``ConfigureMakePythonPackage`` simpleblock
...
### Customised steps in ``ConfigureMakePythonPackage`` simpleblock
...
### Example simpleconfig for ``ConfigureMakePythonPackage`` simpleblock

```python
simpleblock = 'ConfigureMakePythonPackage'
...
### Extra simpleconfig parameters specific to ``CrayToolchain`` simpleblock
...
### Extra simpleconfig parameters specific to ``FortranPythonPackage`` simpleblock
...
### Customised steps in ``FortranPythonPackage`` simpleblock
...
### Extra simpleconfig parameters specific to ``GoPackage`` simpleblock
...
### Customised steps in ``GoPackage`` simpleblock
...
### Extra simpleconfig parameters specific to ``IntelBase`` simpleblock
...
### Customised steps in ``IntelBase`` simpleblock
...
### Extra simpleconfig parameters specific to ``JAR`` simpleblock
...
### Extra simpleconfig parameters specific to ``JuliaBundle`` simpleblock
...
### Extra simpleconfig parameters specific to ``JuliaPackage`` simpleblock
...
### Customised steps in ``JuliaPackage`` simpleblock
...
### Extra simpleconfig parameters specific to ``MakeCp`` simpleblock
...
### Customised steps in ``MakeCp`` simpleblock
...
### Extra simpleconfig parameters specific to ``MesonNinja`` simpleblock
...
### Customised steps in ``MesonNinja`` simpleblock
...
Generic simpleblock to create a software-specific .modulerc file


### Customised steps in ``ModuleRC`` simpleblock
...
### Extra simpleconfig parameters specific to ``OCamlPackage`` simpleblock

simpleconfig parameter|description                       |default value
--------------------|----------------------------------|-------------
``options``         |Dictionary with extension options.|``{}``

### Customised steps in ``OCamlPackage`` simpleblock
...
### Extra simpleconfig parameters specific to ``OctavePackage`` simpleblock

simpleconfig parameter|description                       |default value
--------------------|----------------------------------|-------------
``options``         |Dictionary with extension options.|``{}``

### Customised steps in ``OctavePackage`` simpleblock
...
(derives from [``Binary``](#binary), ``SimpleBlock``)

Support for installing packed binary software.
Just unpack the sources in the install dir


### Extra simpleconfig parameters specific to ``PackedBinary`` simpleblock
...
### Customised steps in ``PackedBinary`` simpleblock
...
### Extra simpleconfig parameters specific to ``PerlBundle`` simpleblock
...
(derives from ``ExtensionSimpleBlock``, [``ConfigureMake``](#configuremake))

Builds and installs a Perl module, and can provide a dedicated module file.

### Extra simpleconfig parameters specific to ``PerlModule`` simpleblock
...
### Customised steps in ``PerlModule`` simpleblock
...
### Extra simpleconfig parameters specific to ``PythonBundle`` simpleblock
...
### Extra simpleconfig parameters specific to ``PythonPackage`` simpleblock
...
### Customised steps in ``PythonPackage`` simpleblock
...
### Extra simpleconfig parameters specific to ``RPackage`` simpleblock
...
### Customised steps in ``RPackage`` simpleblock
...
### Extra simpleconfig parameters specific to ``Rpm`` simpleblock
...
### Customised steps in ``Rpm`` simpleblock
...
### Extra simpleconfig parameters specific to ``RubyGem`` simpleblock
...
### Customised steps in ``RubyGem`` simpleblock
...
### Extra simpleconfig parameters specific to ``SCons`` simpleblock

simpleconfig parameter|description                              |default value
--------------------|-----------------------------------------|-------------
``prefix_arg``      |Syntax for specifying installation prefix|``"PREFIX="``

### Customised steps in ``SCons`` simpleblock
...
### Extra simpleconfig parameters specific to ``SystemCompiler`` simpleblock
...
### Extra simpleconfig parameters specific to ``SystemMPI`` simpleblock
...
### Extra simpleconfig parameters specific to ``Tarball`` simpleblock
...
### Customised steps in ``Tarball`` simpleblock
...
Compiler toolchain simpleblock: nothing to install, just generate module file.

### Extra simpleconfig parameters specific to ``Toolchain`` simpleblock
...
### Extra simpleconfig parameters specific to ``VSCPythonPackage`` simpleblock
...
### Extra simpleconfig parameters specific to ``VersionIndependentPythonPackage`` simpleblock
...
### Customised steps in ``VersionIndependentPythonPackage`` simpleblock
...
### Customised steps in ``Waf`` simpleblock
