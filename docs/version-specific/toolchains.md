...
**nvompi**          |nvidia-compilers|OpenMPI      |*(none)*                 |*(none)*
**nvompic**         |nvidia-compilers|OpenMPI      |*(none)*                 |*(none)*
**nvpsmpi**         |nvidia-compilers|psmpi        |*(none)*                 |*(none)*
**nvpsmpic**        |nvidia-compilers|psmpi        |*(none)*                 |*(none)*
