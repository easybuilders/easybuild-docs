...
``oneapi_fortran``         |Use oneAPI Fortran compiler ifx instead of classic Intel Fortran compiler (auto-enabled for Intel compilers version 2024.0.0, or newer)   |``None``
``openmp``                 |Enable OpenMP                                                                                                                             |``False``
``opt``                    |High compiler optimizations                                                                                                               |``False``
``optarch``                |Enable architecture optimizations                                                                                                         |``True``
``packed-linker-options``  |Pack the linker options as comma separated list                                                                                           |``False``
...
### Available options for ifbf toolchain
...
### Available options for iofbf toolchain
...
### Available options for lfbf toolchain
...
### Available options for lfoss toolchain
...
### Available options for llvm-compilers toolchain
...
### Available options for lmpflf toolchain
...
### Available options for lmpich toolchain
...
### Available options for nvidia-compilers toolchain
...
### Available options for rfbf toolchain
...
### Available options for rfoss toolchain
...
### Available options for rocm-compilers toolchain
...
### Available options for rompi toolchain
