...
See also [Requirements](installation.md#requirements)
...
!!! note
    ...
    an EasyBuild configuration file; see [Supported configuration types](configuration.md#supported-configuration-types).
...
(see [Overall prefix path](configuration.md#overall-prefix-path-prefix).
...
for sources/patches (see also [Source path](configuration.md#source-path-sourcepath)).
