...
As of April 2026 (EasyBuild 5.3.0) the latest (common) toolchain generation is `2026.1`.

* Supported common toolchains:
    * 2026.1 (GCC 15.2.0)
    * 2025b (GCC 14.3.0)
    * 2025a (GCC 14.2.0)
    * 2024a (GCC 13.3.0)
    * 2023b (GCC 13.2.0)
    * 2023a (GCC 12.3.0)
* Deprecated: 2022b (GCC 12.2.0), 2022a (GCC 11.3.0)
* Archived (and unsupported): 2021b (GCC 11.2.0), and older
